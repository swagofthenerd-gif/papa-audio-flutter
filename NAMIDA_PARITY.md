...
- [x] Remove-duplicates action with removed count (playlist overflow menu)
...
- [x] Undo for history deletions (snackbar restores the entry + aggregates)
- [x] Listen-based sort keys — most played / first listen / last listen (tile badges: not planned)
