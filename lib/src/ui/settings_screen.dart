        ...
        builder: (context, _) => ListView(
          ...
          children: [
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Display the next track below the seekbar',
                  style: TextStyle(color: PA.textMuted, fontSize: 12)),
              value: st.showUpNext,
              onChanged: (v) => st.update(() => st.showUpNext = v),
            ),
            const _Section('Headphone actions'),
            SwitchListTile(
              activeThumbColor: PA.accent,
              secondary: const Icon(Icons.headphones, color: PA.textSecondary),
              title: const Text('Resume on connect'),
              subtitle: const Text('Auto-play when headphones are plugged in',
                  style: TextStyle(color: PA.textMuted, fontSize: 12)),
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Stop playback when headphones are unplugged',
                  style: TextStyle(color: PA.textMuted, fontSize: 12)),
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Pure black backgrounds (saves battery on AMOLED)',
                  style: TextStyle(color: PA.textMuted, fontSize: 12)),
              value: st.oledTheme,
